...
*Please Note: Event of the client not being able to connect or has been disconnected, the client will repeatedly attempt to reconnect to the server, unless prompted to exit via EXIT or closing the window.
